    ...
    <section id="intro" className="pb-16 border-b border-gray-100">
      ...
      <div className="mb-10">
        {PERSONAL_INFO.summary.split('\n').map((line, i) => (
          <p key={i} className={`text-gray-600 leading-relaxed text-[15px] ${i > 0 ? 'mt-3' : ''}`}>
            {line}
          </p>
        ))}
      </div>
      ...
      {/* About */}
      <div className="mb-10">
        <h2 className="text-xs font-semibold text-gray-400 tracking-widest uppercase mb-4">About</h2>
      ...
      {/* Skills */}
      <div>
        <h2 className="text-xs font-semibold text-gray-400 tracking-widest uppercase mb-4">Skills</h2>
